...
--dizer que o arquivo é só de handler
...
wHead = toWidgetHead [hamlet|
    ...
    <link href=@{StaticR bootstrap_min_css} rel="stylesheet"/>
    <link href=@{StaticR business_casual_css} rel="stylesheet"/>
...
getHomeR = defaultLayout $ do
           addStylesheet $ StaticR lucius_font_lucius
           setTitle "Do Armário à Geladeira - Home"
           wHome >> toWidget $(luciusFile "lucius/font.lucius")
--home
...
getCreditoR = defaultLayout $ do
           ...
           addStylesheet $ StaticR lucius_font_lucius
           wCredito >> toWidget $(luciusFile "lucius/font.lucius")
--creditos
...
getListReceitaR = defaultLayout $ do
           ...
           wListReceitas >> toWidget $(luciusFile "lucius/font.lucius")
--listarReceitas
...
getListIngreR = defaultLayout $ do
           ...
           wListIngre >> toWidget $(luciusFile "lucius/font.lucius")
--listarIngredientes
...
getListCateR = defaultLayout $ do
           ...
           wListCate >> toWidget $(luciusFile "lucius/font.lucius")
--listarCategorias
...
getReceitaR rid = defaultLayout $ do
           ...
           wReceita rid >> toWidget $(luciusFile "lucius/font.lucius")
--receita
...
getCategoriaR cid = defaultLayout $ do
           ...
           wCategoria cid >> toWidget $(luciusFile "lucius/font.lucius")
--categoria
...
getCadastroR = defaultLayout $ do
           ...
           wCadastro >> toWidget $(luciusFile "lucius/font.lucius")
--cadastro
...
getCadIngreR = do
             ...
             defaultLayout $ do 
                 addStylesheet $ StaticR lucius_font_lucius
                 widgetForm CadIngreR enctype widget "Cadastro de Ingredientes" "Cadastrar" 
...
getCadReceitaR = do
             ...
             defaultLayout $ do 
                 addStylesheet $ StaticR lucius_font_lucius
                 widgetForm CadReceitaR enctype widget "Cadastro de Receitas" "Cadastrar" 
...
getCadBuscaR = do
             ...
             defaultLayout $ do 
                 addStylesheet $ StaticR lucius_font_lucius
                 widgetForm CadBuscaR enctype widget "Cadastro de Buscas" "Cadastrar" 
...
getCadCateR = do
             ...
             defaultLayout $ do 
                 addStylesheet $ StaticR lucius_font_lucius
                 widgetForm CadCateR enctype widget "Cadastro de Categorias" "Cadastrar" 
...
getCadUseR = do
             ...
             defaultLayout $ do 
                 addStylesheet $ StaticR lucius_font_lucius
                 widgetForm CadUseR enctype widget "Cadastro de Usuários" "Cadastrar"
...
getLoginR = do
    ...
    defaultLayout $ do 
        addStylesheet $ StaticR lucius_font_lucius
        widgetForm LoginR enc wid "" "Log in" 
